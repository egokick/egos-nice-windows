...
- `Open VM` cold-starts the `WorkRDP` VirtualBox VM from disk, moves the laptop Bluetooth adapter to the VM for passkeys, and resets guest graphics if VirtualBox opens to a black screen. Saved memory states are discarded instead of resumed.

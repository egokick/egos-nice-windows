...
Small ASP.NET Core dashboard that polls Wi-Fi/LAN devices every five minutes, records MAC/IP/online history, and shows timelines, transition events, and day/hour online patterns. This folder contains only the WiFi Devices application and its data.
